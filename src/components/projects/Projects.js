    ...
    return (
        <div className="projects" id="projects">
            ...
            <div className="projects__grid">
                ...
                <SingleProject githublink="https://github.com/asifkhan0410/ipaddresstracker" gotolink="https://ipaddresstracker-seven.vercel.app/" title="IP Ghost" bio="IP Ghost lets you see your own IP Address on the map on the initial page load and lets you search for any IP addresses or domains and see the key information and location" languages={["react","api","Javascript","HTML","CSS"]}/>
